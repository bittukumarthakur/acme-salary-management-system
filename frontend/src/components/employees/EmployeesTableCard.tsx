...
function EmployeeRowActions({ employee }: EmployeeRowActionsProps) {
  ...
  const columns = useMemo<GridColDef<EmployeeGridRow>[]>(
    () => [
      ...
      },
      {
        ...
        minWidth: 140,
        renderCell: ({ row }) => (
          <Typography variant="body1">{toLabel(row.department)}</Typography>
        ),
      },
      {
        field: 'designation',
        ...
        minWidth: 190,
        renderCell: ({ row }) => (
          <Typography variant="body1">{toLabel(row.designation)}</Typography>
        ),
      },
      {
        field: 'basicSalary',
        ...
        renderCell: ({ row }) => (
          <Typography variant="body1">
            {formatSalary(row.basicSalary, row.currency || meta.currency)}
          </Typography>
        ),
      },
      {
      ...
      },
      {
        ...
        minWidth: 100,
        renderCell: ({ row }) => <EmployeeRowActions employee={row} />,
      },
    ],
    [meta.currency],
  )
